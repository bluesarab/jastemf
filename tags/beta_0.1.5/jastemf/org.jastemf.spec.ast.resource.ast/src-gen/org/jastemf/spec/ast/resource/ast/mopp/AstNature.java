...
public class AstNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.jastemf.spec.ast.resource.ast.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.jastemf.spec.ast.resource.ast.mopp.AstBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.jastemf.spec.ast.resource.ast.mopp.AstBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
