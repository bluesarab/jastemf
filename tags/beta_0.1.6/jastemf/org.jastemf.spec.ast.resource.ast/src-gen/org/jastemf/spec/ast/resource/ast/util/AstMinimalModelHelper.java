 ...
 */
public class AstMinimalModelHelper {
	
	private final static org.jastemf.spec.ast.resource.ast.util.AstEClassUtil eClassUtil = new org.jastemf.spec.ast.resource.ast.util.AstEClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + org.jastemf.spec.ast.resource.ast.util.AstStringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = org.jastemf.spec.ast.resource.ast.util.AstListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if(attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + org.jastemf.spec.ast.resource.ast.util.AstStringUtil.capitalize(attribute.getName());
					}
					java.lang.Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = org.jastemf.spec.ast.resource.ast.util.AstListUtil.castListUnchecked(value);
