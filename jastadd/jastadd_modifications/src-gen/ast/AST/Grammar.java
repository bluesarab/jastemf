...
public class Grammar extends ASTNode implements Cloneable {
  ...
  public void abstractAncestors() {
   ...
   /* 
    ...
    // Declared in StateBodyGen.jadd at line 4

	 	   public void genReset(PrintWriter stream) {
		    stream.println("    public void reset() {");
		    if(circularEnabled) {
    ...
    // Declared in StateBodyGen.jadd at line 28
    ...
    // Declared in StateBodyGen.jadd at line 41


		  public void jjtGenASTNode$State(PrintWriter stream, String parserName, boolean rewriteEnabled) {
  ...
  public void addCollDecl(String name, String type, String className, String fileName, int startLine, int endLine, ASTExpression startValue, String combOp, boolean isCircular, ArrayList annotations, jrag.AST.SimpleNode node, String root) {
    ...
    // Declared in CollectionAttributes.jrag at line 815
  ...
  public void addCollEq(String targetName, String targetAttributeName, String attributeType, String reference, ast.AST.List contributionList, String fileName, int startLine, int endLine, boolean refSet, jrag.AST.SimpleNode node, String aspectName) {
    ...
    // Declared in JragCodeGen.jrag at line 104
  ...
  public void genAGCode(PrintStream s, String aspectName) {
    ...
    // Declared in JragCodeGen.jrag at line 127
  ...
  public String genImportsList() {
    ...
    // Declared in JragCodeGen.jrag at line 1427
  ...
  public Iterator inhAttrSet() {
    ...
    // Declared in JragCodeGen.jrag at line 1466
  ...
  public void genRewriteOrderChecks(PrintWriter out) {
    ...
    // Declared in JragCodeGen.jrag at line 1605
...
if(interruptedCircle) {
  ...
  popEvalStack();
    ...
    // Declared in CollectionAttributes.jrag at line 619
    public ASTDecl root() {
boolean interruptedCircle = false;
        if(root_visited)
...
if(interruptedCircle) {
  ...
  popEvalStack();
    ...
    // Declared in JragCodeGen.jrag at line 62
    public Grammar env() {
boolean interruptedCircle = false;
        if(env_visited)
...
if(interruptedCircle) {
  ...
  popEvalStack();
    ...
    // Declared in JragCodeGen.jrag at line 1431
...
if(interruptedCircle) {
  ...
  popEvalStack();
    ...
    // Declared in JragCodeGen.jrag at line 1441
