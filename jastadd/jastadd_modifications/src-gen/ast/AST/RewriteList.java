...
public class RewriteList extends Rewrite implements Cloneable {
  ...
  public void setChildName(String name) {
    ...
    // Declared in JragCodeGen.jrag at line 1580
  ...
  public boolean genRewrite(StringBuffer buf, int index) {
      ...
      buf.append("      List list = (List)getParent();\n");
      buf.append("      int i = list.getIndexOfChild(this);\n");
      buf.append("      List newList = rewrite" + getParentName() + "_" + getChildName() + "();\n");
    ...
    // Declared in JragCodeGen.jrag at line 1625
