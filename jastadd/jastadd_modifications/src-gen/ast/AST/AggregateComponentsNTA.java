...
public class AggregateComponentsNTA extends AggregateComponents implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
        AggregateComponentsNTA node = (AggregateComponentsNTA)super.clone();
    ...
    public ASTNode copy() {
      try {
          AggregateComponentsNTA node = (AggregateComponentsNTA)clone();
    ...
    public ASTNode fullCopy() {
        AggregateComponentsNTA res = (AggregateComponentsNTA)copy();
    ...
    // Declared in ComponentsUtil.jrag at line 73
  ...
  public boolean isNTA() {
    ...
    public AggregateComponentsNTA(Ast p, int i) {
        this(i);
        parser = p;
    }
    ...
    // Declared in Ast.ast line 76
    public AggregateComponentsNTA(Id p0) {
        setChild(p0, 0);
    }
    ...
    public void dumpTree(String indent, java.io.PrintStream pStream) {
        pStream.println(indent + "AggregateComponentsNTA");
