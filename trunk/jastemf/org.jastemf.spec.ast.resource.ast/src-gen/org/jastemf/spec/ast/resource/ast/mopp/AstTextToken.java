...
public class AstTextToken implements org.jastemf.spec.ast.resource.ast.IAstTextToken {
	
	private final org.jastemf.spec.ast.resource.ast.IAstMetaInformation metaInformation = new org.jastemf.spec.ast.resource.ast.mopp.AstMetaInformation();
	private final org.antlr.runtime3_2_0.Token antlrToken;
	
	public AstTextToken(org.antlr.runtime3_2_0.Token antlrToken) {
		super();
