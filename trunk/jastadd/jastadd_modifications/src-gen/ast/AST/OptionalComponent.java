...
public class OptionalComponent extends Components implements Cloneable {
    ...
    // Declared in JaddCodeGen.jrag at line 875
  ...
  public void jjtGenCheckTreeStructure(PrintWriter stream, int j) {
    ...
    // Declared in JaddCodeGen.jrag at line 1256
...
if(interruptedCircle) {
  ...
  popEvalStack();
    ...
    private String constrParmType_compute() {  return  ASTNode.java5 ? "Opt<" + computeImplName(getId().type()) + ">" : "Opt";  }
