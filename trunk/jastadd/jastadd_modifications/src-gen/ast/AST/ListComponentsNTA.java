...
public class ListComponentsNTA extends ListComponents implements Cloneable {
    public void flushCache() {
        super.flushCache();
    }
    public Object clone() throws CloneNotSupportedException {
        ListComponentsNTA node = (ListComponentsNTA)super.clone();
    ...
    public ASTNode copy() {
      try {
          ListComponentsNTA node = (ListComponentsNTA)clone();
    ...
    public ASTNode fullCopy() {
        ListComponentsNTA res = (ListComponentsNTA)copy();
    ...
    // Declared in ComponentsUtil.jrag at line 64
  ...
  public boolean isNTA() {
    ...
    // Declared in Ast.ast line 64

    public ListComponentsNTA(int i) {
        super(i);
    }

    // Declared in Ast.ast at line 6

    public ListComponentsNTA(Ast p, int i) {
        this(i);
        parser = p;
    }
    ...
    // Declared in Ast.ast line 64
    public ListComponentsNTA(Id p0) {
        setChild(p0, 0);
    }
    ...
    public void dumpTree(String indent, java.io.PrintStream pStream) {
        pStream.println(indent + "ListComponentsNTA");
